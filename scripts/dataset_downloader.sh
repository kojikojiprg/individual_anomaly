...
# volleyball
echo "Download volleyball"
mkdir data/volleyball/
cd data/volleyball/
mkdir videos
gdown 1DaUE3ODT_H5mBFi8JzOVBNzVldxfbPbX
unzip volleyball.zip -d videos/
cd ../../
...
rm UCF101TrainTestSplits-DetectionTask.zip
cd ../../
